...
[attr_encrypted](http://github.com/shuber/attr_encrypted/tree/master) is a
...
it in the past. It worked fine, but I came across attr_encrypted and it seemed
more elegant.
...
```ruby
config.gem 'shuber-attr_encrypted', :version => '~>
...
attr_encrypted because it has some conventions that I must have overlooked in
the documentation.

In order to use it correctly, the column in the database needs to be named
'encrypted_ssn’. When you specify which column is to be encrypted with the
